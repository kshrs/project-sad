...
const StudentOnlineCourseCompSchema = new mongoose.Schema(
  {
    ...
    name_of_the_course: { type: String }, // Original: Name of the course
    from_date: { type: Date }, // Original: From_Date
    to_date2: { type: Date }, // Original: To_Date2
    course_offering_platform: { type: String }, // Original: Course_offering_Platform
    file_name: { type: mongoose.Schema.Types.ObjectId, ref: 'uploads.files' }, // Original: File_Name
  },
  { timestamps: true }
);

module.exports = mongoose.model('StudentOnlineCourseComp', StudentOnlineCourseCompSchema);
